...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _setFileDropZoneTitle: function () {
            ...
            if (!true || !self.showPreview || $zone.length === 0 || self.getFileStack().length > 0 || !self.dropZoneEnabled) {
                return;
            }
        ...
        _renderMain: function () {
            var self = this, dropCss = (true && self.dropZoneEnabled) ? ' file-drop-zone' : 'file-drop-disabled',
